/**
 * This file contains the variable values for setting up an existing CloudTrail with cross-account notifications.
 * Please replace the placeholder values with the appropriate values for your environment.
 */
