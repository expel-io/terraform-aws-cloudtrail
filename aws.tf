...
locals {
  ...
  cloudtrail_bucket_encryption_key_arn = var.existing_cloudtrail_kms_key_arn != null ? var.existing_cloudtrail_kms_key_arn : aws_kms_key.cloudtrail_bucket_encryption_key[0].arn
